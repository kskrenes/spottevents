...
Light refreshments will be provided. Limited seats available.`,
    ...
    venue: "https://maps.app.goo.gl/JdVkfLB4er58ufBb9",
    address: "St. Anne's Conference and Event Center - 155 Occidental Blvd, Los Angeles, CA 90026",
    capacity: 50,
    ticketType: "free",
    coverImage:
...
Pizza and drinks provided!`,
    ...
    venue: "https://maps.app.goo.gl/X6DVFioDeQXy4y3v5",
    address: "Brix Studio | Meeting & Event Venue - 211 Columbia St #102, Vancouver, BC V6A 1E7, Canada",
    capacity: 100,
    ticketType: "free",
    coverImage:
...
Food and beverages available for purchase at the venue.`,
    ...
    venue: "https://maps.app.goo.gl/veWy4HFhSHqhLNgX6",
    address: "The Ivy Room At Tree Studios - 12 E Ohio St # 100, Chicago, IL 60611",
    capacity: 120,
    ticketType: "paid",
    ticketPrice: 499,
    coverImage:
...
Continental breakfast included in registration.`,
    ...
    venue: "https://maps.app.goo.gl/PvsNAWVA6xwS8Aoo6",
    address: "Nineteen 25 - 2185 N Broadway #200, Denver, CO 80205",
    capacity: 40,
    ticketType: "paid",
    ticketPrice: 299,
    coverImage:
...
Chai stops included along the way!`,
    ...
    venue: "https://maps.app.goo.gl/UCjF9xcZM5B83mWP6",
    address: "The Farm NYC - 447 Broadway, New York, NY 10013",
    capacity: 25,
    ticketType: "paid",
    ticketPrice: 799,
    coverImage:
...
Laptop required. Course materials provided.`,
    ...
    venue: "https://maps.app.goo.gl/hdwhqqZE17pM9Rhb6",
    address: "The Loft On King Street - 485 King St W Floor 3, Toronto, ON M5V 3M4, Canada",
    capacity: 30,
    ticketType: "free",
    coverImage:
...
Referee provided. Water and energy drinks available. Medical support on standby.`,
    ...
    venue: "https://maps.app.goo.gl/JnaXVXAVPpXsbVd26",
    address: "Draper Startup House by Lawi - R. Santa Cristina, 15 - Santa Teresa, Rio de Janeiro - RJ, 20241-250, Brazil",
    capacity: 56,
    ticketType: "paid",
    ticketPrice: 350,
    coverImage:
...
Taste everything you cook! Great for health enthusiasts and curious foodies alike.`,
    ...
    venue: "https://maps.app.goo.gl/kxYsgbzGYtaLYcGc6",
    address: "Here Spaces - 56 Greek St, London W1D 3DU, United Kingdom",
    capacity: 20,
    ticketType: "paid",
    ticketPrice: 1200,
    coverImage:
...
Energy drinks and snacks available. Exciting commentary and crowd interaction!`,
    ...
    country: "United States",
    timezone: "America/Los_Angeles",
    venue: "https://maps.app.goo.gl/3SUawwGdvMsguzha8",
    address: "The Preserve LA - 1370 N St Andrews Pl, Los Angeles, CA 90028",
    capacity: 80,
    ticketType: "paid",
    ticketPrice: 200,
    coverImage:
...
Open to all genders. Q&A session and networking lunch included.`,
    ...
    country: "Canada",
    timezone: "America/Vancouver",
    venue: "https://maps.app.goo.gl/Si83x653paCqXSaN9",
    address: "The Refinery - 1115 Granville St, Vancouver, BC V6Z 1M1, Canada",
    capacity: 40,
    ticketType: "free",
    coverImage:
...
Transport from Delhi available at additional cost.`,
    ...
    country: "United States",
    timezone: "America/Chicago",
    venue: "https://maps.app.goo.gl/ykBXM22uQ8RX3Zz9A",
    address: "Loft Lucia - 7 N Carpenter St, Chicago, IL 60607",
    capacity: 20,
    ticketType: "paid",
    ticketPrice: 2500,
    coverImage:
...
Refreshments provided. A great way to give back to nature while meeting like-minded people!`,
    ...
    country: "United States",
    timezone: "America/Denver",
    venue: "https://maps.app.goo.gl/7RWy2Py9uAwgVE1C6",
    address: "Evolve at MileHi Event Center - 2827 W 9th Ave, Denver, CO 80204",
    capacity: 100,
    ticketType: "free",
    coverImage:
...
Code examples and cheat sheets provided.`,
    ...
    country: "United States",
    timezone: "America/New_York",
    venue: "https://maps.app.goo.gl/NC9cW5Xe8cQPFB2g8",
    address: "The Assembly - 2 Park Ave, New York, NY 10016",
    capacity: 40,
    ticketType: "paid",
    ticketPrice: 999,
    coverImage:
...
Sleeping bags welcome. Food and drinks provided throughout.`,
    ...
    country: "Canada",
    timezone: "America/Toronto",
    venue: "https://maps.app.goo.gl/dAULhJwraHBZujGC6",
    address: "SPACE on King - 300 King St E, Toronto, ON M5A 1K4, Canada",
    capacity: 60,
    ticketType: "paid",
    ticketPrice: 500,
    coverImage:
...
Lunch and refreshments included. Bring your laptop!`,
    ...
    country: "Brazil",
    timezone: "America/Sao_Paulo",
    venue: "https://maps.app.goo.gl/Pzuf5e62kawouvLJ7",
    address: "Centro Empresarial Mourisco - Praia de Botafogo, 501 - Botafogo, Rio de Janeiro - RJ, 22250-040, Brazil",
    capacity: 40,
    ticketType: "paid",
    ticketPrice: 1499,
    coverImage:
...
Continental breakfast and unlimited coffee included!`,
    ...
    country: "United Kingdom",
    timezone: "Europe/London",
    venue: "https://maps.app.goo.gl/KGyN1bS2M8LHNEYX6",
    address: "The Derby - St Chad's St, London WC1H 8AG, United Kingdom",
    capacity: 35,
    ticketType: "paid",
    ticketPrice: 399,
    coverImage:
...
Perfect for team building and corporate bonding!`,
    ...
    country: "United States",
    timezone: "America/Los_Angeles",
    venue: "https://maps.app.goo.gl/fj1vQyqmcjHHxWw68",
    address: "Shrine Auditorium and Expo Hall - 665 W Jefferson Blvd, Los Angeles, CA 90007",
    capacity: 180,
    ticketType: "paid",
    ticketPrice: 500,
    coverImage:
...
Healthy snacks and herbal teas included.`,
    ...
    country: "United States",
    timezone: "America/Chicago",
    venue: "https://maps.app.goo.gl/jbUmUwNLmYRrU1DN6",
    address: "Catalyst Ranch - 656 W Randolph St Ste 4E, Chicago, IL 60661",
    capacity: 25,
    ticketType: "paid",
    ticketPrice: 899,
    coverImage:
  ...
  },
  {
    ...
    country: "United States",
    timezone: "America/Denver",
    venue: "https://maps.app.goo.gl/4bdPmcNz667SPkYA8",
    address: "SKYLIGHT - 833 Santa Fe Dr, Denver, CO 80204",
    capacity: 10,
    ticketType: "free",
    coverImage:
  ...
  },
  {
    ...
    country: "Canada",
    timezone: "America/Toronto",
    venue: "https://maps.app.goo.gl/5mLDVWUKtXmQwfNF7",
    address: "The Rostie Group - 20 Bay St. 11th floor, Toronto, ON M5J 2N8, Canada",
    capacity: 75,
    ticketType: "paid",
    ticketPrice: 250,
    coverImage:
  ...
  {
    title: 'The Lo-Fi Majesty of Guided By Voices: An Intimate Deep Dive',
    description: 'Explore the prolific and influential career of indie rock legends Guided By Voices. This event will delve into their unique songwriting, lo-fi aesthetic, and enduring impact on independent music, perfect for both longtime fans and new listeners alike. Discover the magic behind their vast discography.',
    category: 'music',
    tags: ["music"],
    city: "Dayton",
    state: "Ohio",
  ...
  {
    title: 'Beat the Delay: Strategies to Overcome Procrastination',
    description: `Are you constantly putting off important tasks? This workshop will equip you with practical tools and techniques to conquer procrastination once and for all.

    Learn to identify the root causes of delay and develop actionable strategies for improved productivity and focus. 

    - Discover effective time management methods 
    - Build habits for sustained motivation 
    - Transform your approach to deadlines.`,
    category: 'education',
    tags: [ 'education', 'productivity', 'timemanagement', 'selfimprovement' ],
    city: "Denver",
    state: "Colorado",
    country: "United States",
    timezone: "America/Denver",
...
// Helper functions
function getRandomFutureDate(minDays = 60, maxDays = 190) {
  const now = Date.now();
