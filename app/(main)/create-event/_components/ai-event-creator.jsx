...
const AiEventCreator = ({ onEventGenerated }) => {
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className='sm:max-w-[425px]'>
        <DialogHeader>
          ...
          <DialogDescription>Describe your event idea and let AI create the details for you.</DialogDescription>
        </DialogHeader>
        <div className='space-y-4'>
          <Textarea 
            ...
            rows={6}
            className='resize-none break-words sm:max-w-[375px]'
            maxLength={500}
          />
          <p className='text-sm text-muted-foreground mt-2'>{`${500 - prompt.length} characters remaining`}</p>
